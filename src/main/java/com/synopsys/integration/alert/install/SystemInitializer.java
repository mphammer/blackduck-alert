...
public class SystemInitializer {
    ...
    private Optional<BlackDuckEntity> getGlobalBlackDuckConfigEntity() {
        final List<BlackDuckEntity> globalConfigList = globalBlackDuckRepository.findAll();
    ...
    private void saveBlackDuckConfiguration(final RequiredSystemConfiguration requiredSystemConfiguration) {
        final Optional<BlackDuckEntity> blackDuckConfigEntity = getGlobalBlackDuckConfigEntity();
        final BlackDuckEntity blackDuckConfigToSave = new BlackDuckEntity(requiredSystemConfiguration.getBlackDuckConnectionTimeout(),
