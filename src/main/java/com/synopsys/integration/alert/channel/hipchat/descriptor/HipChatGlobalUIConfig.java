...
public class HipChatGlobalUIConfig extends UIConfig {
    public static final String KEY_API_KEY = HipChatChannel.COMPONENT_NAME + ".api.key";
    public static final String KEY_HOST_SERVER = HipChatChannel.COMPONENT_NAME + ".host.server";
