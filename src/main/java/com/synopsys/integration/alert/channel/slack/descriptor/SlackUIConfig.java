...
public class SlackUIConfig extends UIConfig {
    public static final String KEY_WEBHOOK = SlackChannel.COMPONENT_NAME + ".webhook";
    public static final String KEY_CHANNEL_NAME = SlackChannel.COMPONENT_NAME + ".channel.name";
    public static final String KEY_CHANNEL_USERNAME = SlackChannel.COMPONENT_NAME + ".channel.username";
